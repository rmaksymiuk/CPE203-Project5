...
//Leaving all parse functions in the Functions.java file
...
//Leaving create Functions in Functions.java
    ...
    private static Obstacle createObstacle(
    ...
    private static Fairy createFairy(
            String id,
            Point position,
            int actionPeriod,
            int animationPeriod,
